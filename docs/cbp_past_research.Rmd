...
The relationship is core ecological topic, and nearly all theory predicts a positive relationship between stability and diversity.
Yet, empirical studies yield inconsistent results, with reports of negative, neutral, and positive relationships.
In a recent paper in \emph{Ecology Letters}, I reconciled theoretical and empirical findings by showing that the mechanism of species coexistence shapes the diversity-stability relationship.
...
It is that last finding I wish to develop further and test as part of my CBP Postdoctoral Fellowship.
