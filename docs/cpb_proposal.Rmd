...
\begin{equation}
N_i(t+1) = \left(s_i[1-g_i(t)]N_i(t) + \lambda_i g_i(t)N_i(t)\right) \div \left( 1 + \sum\limits_{j=1}^n{\alpha_{ij}g_j(t)N_j(t)} \right)
\end{equation}
...
A. Hastings and I will lead this work, with significant input from J. Gremer and S. Harrison as we link our findings to empirical systems and explore whether certain processes can be recovered from abundance measures alone.
